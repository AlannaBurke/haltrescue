...
<InfographicShare imageSrc="/img/ferrets/ferret-heart-disease.png" />
...
1.  **Stethoscope Examination:** The vet may hear a heart murmur (an abnormal sound) or muffled heart and lung sounds if there is fluid in the chest.

2.  **X-rays:** Chest x-rays are crucial. They can show if the heart is enlarged and, most importantly, can reveal the presence of fluid in the chest (pleural effusion).

3.  **Echocardiogram (Ultrasound of the Heart):** This is the gold standard for diagnosing heart disease. It allows the veterinarian to see the heart muscle in action, measure the thickness of the heart walls, and assess how well it is pumping.
