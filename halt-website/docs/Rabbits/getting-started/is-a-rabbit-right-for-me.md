...
sidebar_position: 5
tags: [rabbits, getting started, cost]
...
<InfographicShare
  imageSrc="/img/rabbits/is-a-rabbit-right-for-me.png"
  alt="Is a Rabbit Right for You? Quick reference guide from HALT Rescue"
  title="Is a Rabbit Right for You?"
/>
...
| Veterinary care | Exotic vet required; spay/neuter is essential; GI stasis is a common emergency |
...
*HALT Rescue has experience with rabbits and is happy to answer your questions. Note that rabbit surrenders are currently paused due to capacity — [contact us](/about#contact) for current availability.*
