...
sidebar_position: 6
tags: [chinchillas, enrichment, training, behavior, mental health]
description: "Chinchillas are active, athletic animals that need daily out-of-cage time and enrichment. Learn how to safely play with and train your chinchilla."
---
...
> **Temperature warning:** Chinchillas are extremely heat-sensitive and must never be allowed to exercise in a room warmer than 21°C (70°F). Always check the room temperature before out-of-cage time. See our [Heat Stroke](/docs/general-care/health-and-medical/heat-stroke) article for more information.
...
- Remove toxic houseplants (see our [Dangerous Plants](/docs/general-care/safety/dangerous-plants) article)
