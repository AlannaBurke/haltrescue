...
<figure>
  <img src="/img/chinchillas/chinchilla-heat-stroke.png" alt="Infographic showing heat stroke danger zones, warning signs, and emergency response for chinchillas" />
  <figcaption>Heat stroke in chinchillas: danger zones, warning signs, and emergency response.</figcaption>
</figure>
...
1. **Move the chinchilla** to the coolest room in your home immediately
2. **Apply cool (not cold) water** to the ears and feet — these are the primary heat exchange surfaces
3. **Use a fan** to create gentle airflow around the chinchilla
4. **Offer fresh cool water** — do not force the chinchilla to drink
5. **Contact your vet immediately** — even if the chinchilla appears to recover, internal damage may have occurred
...
[^1]: Yarto-Jaramillo E. Respiratory system anatomy, physiology, and disease: Guinea pigs and chinchillas. *Veterinary Clinics: Exotic Animal Practice*. 2011;14(2):339–355.

[^2]: LafeberVet. Heatstroke in Exotic Companion Mammals. Published April 2012. Available at: [https://lafeber.com/vet/heatstroke-in-exotic-companion-mammals/](https://lafeber.com/vet/heatstroke-in-exotic-companion-mammals/)
