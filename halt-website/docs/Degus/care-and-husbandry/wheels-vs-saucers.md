...
tags: [degus, care, enrichment, wheels, exercise]
---

import InfographicShare from '@site/src/components/InfographicShare';

<InfographicShare
  imageSrc="/img/degus/degu-wheels-vs-saucers.png"
  alt="Kawaii infographic showing minimum wheel sizes for degus, solid surface requirements, saucer size thresholds, and wheel checklist"
  title="Degu Wheel Guide: Go Big or Go Home!"
/>
...
- **Minimum diameter: 30 cm (12 inches)**
- **Preferred diameter: 40 cm (16 inches)**[^1] [^2]
...
[^1]: DeguWorld ProBoards. *Wheel thread — minimum size discussion.* https://deguworld.proboards.com/thread/19221/wheel

[^2]: eRodent. *Wheels for Rodents.* http://www.erodent.co.uk/wheels.htm

[^3]: MN Pocket Pet Rescue. *Wheel Guide.* https://www.mnpocketpetrescue.org/wheel-guide

[^4]: Degus International Community Forum. *Fundamental Requirements for Safe Wheels, Discs and Saucers.* https://forum.degus-international-community.org/viewtopic.php?f=84&t=1523
