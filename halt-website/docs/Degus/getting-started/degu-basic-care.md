...
![Degu Basic Care](/img/degus/degu-basic-care.png)
...
*   **Full Cage Clean:** A full cage cleaning should be done weekly. Degus can be messy, and a clean environment is crucial for their health.
    1.  Move your degus to a secure temporary carrier.
    2.  Discard all old bedding.
    3.  Wash the cage, shelves, and accessories with a pet-safe cleaner.
    4.  Refill with fresh bedding and return all items to the cage.
