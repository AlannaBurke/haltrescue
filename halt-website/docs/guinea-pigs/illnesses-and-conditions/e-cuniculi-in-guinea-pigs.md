...
<InfographicShare src="/img/guinea-pigs/dental-prevention.png" />
...
| Treatment | Details |
|---|---|
| **Fenbendazole** | The primary antiparasitic drug used; typically given for 28 days; may need to be repeated[^1] |
| **Albendazole** | An alternative antiparasitic; used in some cases |
| **Anti-inflammatory drugs** | Meloxicam or prednisolone to reduce brain inflammation |
| **Supportive care** | Fluid therapy, syringe feeding, warmth, and nursing care for severely affected animals |
| **Eye management** | Cataract surgery may be considered in specialist settings |
